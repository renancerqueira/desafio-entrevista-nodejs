...
describe('CompanyFakerBuilder Unit Tests', () => {
  ...
  describe('social_name prop', () => {
    const companyFaker = CompanyFakeBuilder.aCompany();
    ...
    test('withSocialName', () => {
      ...
      expect($this).toBeInstanceOf(CompanyFakeBuilder);
    ...
    it('should pass index to social_name factory', () => {
      ...
      const fakerMany = CompanyFakeBuilder.theCompanies(2);
      fakerMany.withSocialName((index) => `test social_name ${index}`);
      const categories = fakerMany.build();

      expect(categories[0].social_name).toBe(`test social_name 0`);
      expect(categories[1].social_name).toBe(`test social_name 1`);
    });
  ...
  describe('fantasy_name prop', () => {
    ...
    it('should pass index to fantasy_name factory', () => {
      ...
      expect(categories[0].fantasy_name).toBe(`test fantasy name 0`);
      expect(categories[1].fantasy_name).toBe(`test fantasy name 1`);
    });
  ...
  describe('email prop', () => {
    ...
    it('should pass index to email factory', () => {
      ...
      expect(categories[0].email).toBe(`test email 0`);
      expect(categories[1].email).toBe(`test email 1`);
    });
  ...
  describe('password prop', () => {
    ...
    it('should pass index to password factory', () => {
      ...
      expect(categories[0].password).toBe(`test password 0`);
      expect(categories[1].password).toBe(`test password 1`);
    });
  ...
  describe('document prop', () => {
    ...
    it('should pass index to document factory', () => {
      ...
      expect(categories[0].document).toBe(`test document 0`);
      expect(categories[1].document).toBe(`test document 1`);
    });
  ...
  describe('phone prop', () => {
    ...
    it('should pass index to phone factory', () => {
      ...
      expect(categories[0].phone).toBe(`test phone 0`);
      expect(categories[1].phone).toBe(`test phone 1`);
    });
  ...
  it('should create many categories', () => {
    const companyFaker = CompanyFakeBuilder.theCompanies(2);
    let categories = companyFaker.build();
